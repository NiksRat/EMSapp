...
import SummaryCard from "./SummaryCardAcc";
import {
...
const AccountantSummary = () => {
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        const res = await axios.get("http://localhost:5000/api/accountant/summary", {
          headers: {
  ...
  return (
    <div className="p-6">
      <h3 className="text-2xl font-bold">{t("accountantDashboard")}</h3>
